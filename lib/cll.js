...
cll.prototype.generateMessage = function(level, text){
  ...
  if (conf.colors) this.paint(msg, level);
  if (conf.padding) msg.unshift(conf.padding);
...
cll.prototype.warning = function(text, cb){ this.log('warning', text, cb) };
